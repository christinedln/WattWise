...
import { AlertCircle, CheckCircle, Loader, UsersRound, Shield, RotateCcw } from "lucide-react";
...
export default function CreateAccountPage() {
  ...
  return (
    <div className="space-y-6 w-full" style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Text', 'SF Pro Display', 'Helvetica Neue', Arial, sans-serif", letterSpacing: '-0.01em' }}>
      ...
      <section className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
        <div className="flex items-start gap-4">
          <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-[#e8f5ee] border border-[#b2d8c0] flex-shrink-0">
            <UsersRound className="h-5 w-5 text-[#1a7a45]" />
          </div>
          <div>
            <p className="text-xs uppercase tracking-widest text-gray-400 font-medium">Account Management</p>
            <h2 className="mt-0.5 text-xl font-bold text-gray-900">Create Account</h2>
        ...
        <form onSubmit={handleSubmit}>
          <div className="px-6 pt-5 pb-6 space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                <span className="absolute left-3.5 top-1/2 -translate-y-1/2 pointer-events-none">
                  <UsersRound className="h-4 w-4 text-[#1a7a45]" />
                </span>
                <input
                  id="displayName"
                  name="displayName"
